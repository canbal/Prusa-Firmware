...
const char MSG_WIZARD_WELCOME_EN[] PROGMEM = "Hi, I am your Not So Original Prusa i3 printer. Would you like me to guide you through the setup process?";
const char MSG_WIZARD_WELCOME_CZ[] PROGMEM = "Dobry den, jsem vase tiskarna Not So Original Prusa i3. Chcete abych Vas provedla kalibracnim procesem?";
const char MSG_WIZARD_WELCOME_IT[] PROGMEM = "Ciao, sono la tua stampante Not So Original Prusa i3. Gradiresti aiuto attraverso il processo di configurazione?";
const char MSG_WIZARD_WELCOME_ES[] PROGMEM = "Hola, soy tu impresora Not So Original Prusa i3. Quieres que te guie a traves de la configuracion?";
const char MSG_WIZARD_WELCOME_PL[] PROGMEM = "Czesc, jestem Twoja drukarka Not So Original Prusa i3. Czy potrzebujesz pomocy z instalacja?";
const char MSG_WIZARD_WELCOME_DE[] PROGMEM = "Hallo, ich bin dein Not So Original Prusa i3 Drucker. Moechten Sie meine Hilfe durch den Setup-Prozess?";
